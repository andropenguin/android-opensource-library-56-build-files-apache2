        ...
        findViewById(R.id.button_save).setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        rawDb.replace(SampleRawOpenHelper.TABLE_NAME, null, values);
                        load(db);
                    }
                }
        );
...
//                (TextView)findViewById(R.id.raw_data));
        loadRaw(new File(getApplicationContext().getApplicationInfo().dataDir + "/cipher_db.db"),
                (TextView)findViewById(R.id.raw_data));
//        loadRaw(new File(getExternalFilesDir(null), "cipher_db_raw.db"),
//                (TextView)findViewById(R.id.unencrypted_data));
        loadRaw(new File(getApplicationContext().getApplicationInfo().dataDir + "/cipher_db_raw.db"),
                (TextView)findViewById(R.id.unencrypted_data));
